...
Do not expose this as a public pod. This is for internal use only. We are going to reference this pod in our framework pod.
  ...
  s.source_files = 'IDTechPod/IDTech.framework/Versions/A/Headers/*.{h}','IDTechPodModuleMap.modulemap'
  
  s.public_header_files = 'IDTechPod/IDTech.framework/Versions/A/Headers/*.{h}'
  
  s.vendored_frameworks = 'IDTechPod/IDTech.framework'
  ...
  s.preserve_paths = 'IDTechPod/IDTech.framework','IDTechPod/IDTech.bundle','IDTechPodModuleMap.modulemap'
  
  s.xcconfig = { 'SWIFT_INCLUDE_PATHS' => '$(PODS_ROOT)/IDTechPod/IDTechPodModuleMap.modulemap' }
